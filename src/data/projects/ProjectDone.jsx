export const projectsDone = [
  ...
  },
  {
    ...
    techImages: [
      ...
      "router.svg",
      "mongodb.svg",
      "razorpay.svg", // ✅ You need to add this icon to your /public/skill folder
      "axios.svg", // ✅ You need to add this icon to your /public/skill folder
      "api.svg", // ✅ Optional custom REST API icon
      "css.svg",
    ],
