...
import wheelImg from "../assets/wheel.png"; // ✅ Ensure this image has visible spokes/markings
...
export default function Wheel() {
  ...
  // 🌀 Mouse wheel hover → rotate + scroll
