...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    (async function() {
      ...
      function t(n) {
        var _a3;
        return y = n.exports, q = y.ma, i1(), F = y.ra, H.unshift(y.na), a1--, (_a3 = s.monitorRunDependencies) == null ? void 0 : _a3.call(s, a1), a1 == 0 && m1 && (n = m1, m1 = null, n()), y;
      }
    ...
    function j2() {
      function t() {
        ...
        if (!j1 && (j1 = true, s.calledRun = true, !s1)) {
          if (N1(H), v(s), (_a2 = s.onRuntimeInitialized) == null ? void 0 : _a2.call(s), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
...
var Q1 = ({ animationId: d, autoplay: i, backgroundColor: r, className: s, createDotLottie: v, data: M, dotLottieRefCallback: z, layout: D, loop: G, mode: E, playOnHover: l1, renderConfig: u1, segment: $, speed: K, src: q, style: s1, themeData: h1, themeId: B, useFrameInterpolation: I, workerId: t1, ...J }) => {
  ...
  let E1 = (0, import_react.useCallback)((H) => {
    var _a, _b;
    w.current = H, H ? L.current = v({ ...i1.current, canvas: H }) : ((_a = L.current) == null ? void 0 : _a.destroy(), L.current = null), (_b = f1.current) == null ? void 0 : _b.call(f1, L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    ...
    var _a;
    (_a = L.current) == null ? void 0 : _a.setLayout(D ?? {});
  }, [D == null ? void 0 : D.fit, (D == null ? void 0 : D.align) && D.align[0], (D == null ? void 0 : D.align) && D.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: s, ...!s && { style: { width: "100%", height: "100%", lineHeight: 0, ...s1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: E1, style: { width: "100%", height: "100%" }, ...J }) });
};
var u0 = (d) => new B1(d);
