...
export const Component = ({ size = 180, text = "Generating", inline = false }) => {
        ...
        >
          <div className="flex space-x-0.5 z-10">
            {letters.map((letter, index) => (
              <span
                key={index}
                className="inline-block text-indigo-900 dark:text-indigo-200 opacity-40 animate-loaderLetter text-xs font-bold tracking-wider"
          ...
          @keyframes loaderCircle {
            0% {
              ...
              box-shadow:
                ...
                0 18px 18px 0 rgba(30, 64, 175, 0.4),
                0 0 2px 1px rgba(56, 189, 248, 0.3);
            }
            50% {
              ...
              box-shadow:
                ...
                0 12px 18px 0 rgba(0, 93, 255, 0.4),
                0 0 2px 1px rgba(56, 189, 248, 0.3);
            }
            100% {
          ...
          @media (prefers-color-scheme: dark) {
            .animate-loaderCircle {
              box-shadow:
                ...
                0 18px 18px 0 rgba(156, 163, 175, 0.4),
                0 0 2px 1px rgba(107, 114, 128, 0.3);
            }
          }
        `}} />
      </div>
